...
const Portfolio: React.FC = () => {
  ...
  const portfolioItems = [
    ...
    },
    {
      id: 6,
      titleEn: 'IDEX 2022',
      titleAr: 'معرض IDEX ٢٠٢٢',
      category: 'conferences',
      location: language === 'en' ? 'Baghdad' : 'بغداد',
      year: '2022',
      images: [
        'https://eznbpoxfishlsawvnmio.supabase.co/storage/v1/object/public/alhadathevents//IDEX-event-1.JPG',
        'https://eznbpoxfishlsawvnmio.supabase.co/storage/v1/object/public/alhadathevents//IDEX-event-2.JPG',
        'https://eznbpoxfishlsawvnmio.supabase.co/storage/v1/object/public/alhadathevents//IDEX-event-3.JPG',
      ],
