            ...
            <div className="prose prose-lg max-w-none">
              {language === 'en' ? (
                <div className="space-y-8 text-gray-600 dark:text-beige-100 font-inter leading-relaxed transition-colors duration-300">
                  ...
                  <section>
                    <h2 className="text-2xl font-playfair font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Our Services</h2>
                    <p>
                  ...
                  <section>
                    <h2 className="text-2xl font-playfair font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Client Responsibilities</h2>
                  ...
                  <section>
                    <h2 className="text-2xl font-playfair font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Payment Terms</h2>
                    <p>
                  ...
                  <section>
                    <h2 className="text-2xl font-playfair font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Cancellation Policy</h2>
                    <p>
                  ...
                  <section>
                    <h2 className="text-2xl font-playfair font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Contact Information</h2>
                    <p>
                ...
                <div className="space-y-8 text-gray-600 dark:text-beige-100 font-inter leading-relaxed transition-colors duration-300" dir="rtl">
                  ...
                  <section>
                    <h2 className="text-2xl font-playfair font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">خدماتنا</h2>
                    <p>
                  ...
                  <section>
                    <h2 className="text-2xl font-playfair font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">مسؤوليات العميل</h2>
                    <ul className="list-disc list-inside space-y-2">
                  ...
                  <section>
                    <h2 className="text-2xl font-playfair font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">شروط الدفع</h2>
                    <p>
                  ...
                  <section>
                    <h2 className="text-2xl font-playfair font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">سياسة الإلغاء</h2>
                    <p>
                  ...
                  <section>
                    <h2 className="text-2xl font-playfair font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">معلومات الاتصال</h2>
                    <p>
